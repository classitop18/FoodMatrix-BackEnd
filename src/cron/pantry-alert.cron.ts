...
import { pantryItems, ingredients, pantryAlerts, accounts } from "../database/schemas/schema.js";
...
export function initializePantryCron() {
    ...
    logger.info("🕐 Pantry alert cron job initialized (runs at 8 AM and 6 PM daily)");
}
