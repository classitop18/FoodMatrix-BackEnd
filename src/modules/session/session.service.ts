import { ISessionRepository, Session, SessionInsert } from "./session.repository";
...
export interface ISessionService {
    ...
    findValidSessionByRefreshToken(userId: string, refreshTokenHash: string): Promise<Session | null>;
}
...
export class SessionService implements ISessionService {
    ...
    async findValidSessionByRefreshToken(userId: string, refreshTokenHash: string): Promise<Session | null> {
        return this.sessionRepo.findValidSessionByRefreshToken(userId, refreshTokenHash);
    }
}
