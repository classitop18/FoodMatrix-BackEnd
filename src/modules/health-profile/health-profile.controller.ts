...
export class HealthProfileController {
  ...
  createHealthProfile = async (
    ...
    try {
      ...
      const profile = await this.service.createHealthProfile(
        validatedData,
        userId,
      );
  ...
  getHealthProfileByMember = async (
    ...
    try {
      ...
      const profile = await this.service.getHealthProfileByMember(
        memberId,
        userId,
      );
    } catch (error) {
  ...
  updateHealthProfile = async (
    ...
    try {
      ...
      const profile = await this.service.updateHealthProfile(
        id,
        validatedData,
        userId,
      );
